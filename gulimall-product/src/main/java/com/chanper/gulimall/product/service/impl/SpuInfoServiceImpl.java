...
import com.chanper.common.constant.ProductConstant;
...
import com.chanper.gulimall.product.entity.*;
import com.chanper.gulimall.product.feign.CouponFeignService;
import com.chanper.gulimall.product.feign.SearchFeignService;
import com.chanper.gulimall.product.feign.WareFeignService;
import com.chanper.gulimall.product.service.*;
import com.chanper.gulimall.product.vo.*;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void saveSpuInfo(SpuSaveVo vo) {
        ...
        // 5.保存所有sku信息
        // 5.1 保存spu的积分信息；gulimall_sms->sms_spu_bounds
        ...
        if (skus != null && skus.size() > 0) {
            skus.forEach(item -> {
                ...
                // 4) sku的优惠、满减、会员价格等信息  [跨库 gulimall_sms->sms_sku_ladder\sms_sku_full_reduction\sms_member_price]
