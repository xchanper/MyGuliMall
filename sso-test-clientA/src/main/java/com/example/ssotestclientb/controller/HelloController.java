...
public class HelloController {
    ...
    public String employees(Model model, HttpSession session, @RequestParam(value = "userKey", required = false) String userKey) {
        ...
        // 没有登录信息，前往 sso
        if (loginUser == null) {
            return "redirect:" + ssoServer + "?url=http://ssoclienta.com:8081/employees";
        } else {
